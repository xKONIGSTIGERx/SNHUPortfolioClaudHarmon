...
main()
```
These scripts are written in python to insert and update data within a mongo db. Specifically these were created to work with the restful_api to work on its mongo db. This is a very important artifact for databases to show that I know how to create an interface for databases and then understanding databases as well. Databases are very important because every piece of software that manages any sort of data will be using one so being able to make update and delete scripts and put them into your programs is very important for a software developer and that is why I chose these two artifacts. For enhancing I cleaned them up, added some more logic, and made sure their implementation was done properly. Overall am proud of these two and am excited to see what database development and management I do in my professional capacities.
